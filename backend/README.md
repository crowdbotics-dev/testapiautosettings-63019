...
## Project Structure
    ...
    ├── testapiautosettings_63019  # Django project configurations
...
1. Clone this repo and `cd testapiautosettings_63019`
...
2. Clone this repo and `cd testapiautosettings_63019`
